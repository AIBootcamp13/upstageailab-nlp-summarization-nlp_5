...
def compute_metrics(config, tokenizer, pred):
    ...
    labels = tokenizer.batch_decode(labels, skip_special_tokens=False, clean_up_tokenization_spaces=True)
...
def load_trainer_for_train(config,generate_model,tokenizer,train_inputs_dataset,val_inputs_dataset):
    ...
    lr=float(config['training']['learning_rate']),  # str -> float 변환 명시
    betas=(0.9, 0.999),
    eps=1e-08,
