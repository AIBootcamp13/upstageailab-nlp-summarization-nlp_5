#!/bin/bash
# RTX 3090 맞춤 7개 주요 모델 실험 스크립트 (mT5 XLSum 3단계 + 기존 4개)
...
if [[ "$ONE_EPOCH_MODE" == "true" ]]; then
    ...
    echo -e "⏱️  예상 소요 시간: 30-45분 (1에포크 모드 - 빠른 테스트용)"
...
{
    echo "7개 주요 모델 실험 요약 (mT5 XLSum 3단계 + RTX3090 최적화 4개)"
    echo "======================"
