...
class DialogueSummarizationTrainer:
    ...
    def _load_tokenizer(self) -> None:
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(model_checkpoint, use_fast=use_fast)
...
if __name__ == "__main__":
    ...
    if not args.sweep:
        wandb.init(project="nlp-dialogue-summarization", name="manual_training", config={"manual_run": True})
